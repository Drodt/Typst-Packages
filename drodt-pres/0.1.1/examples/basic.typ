...
=== Highlight
This is #highlight(fill: blue.C)[highlighted in blue]. This is #highlight(
  fill: yellow.C,
)[highlighted in yellow]. This is #highlight(fill: green.C)[highlighted in
  green]. This is #highlight(fill: red.C)[highlighted in red].
...
#hero(
  ...
  txt: (
    text: "This is an "
      + highlight(
        fill: yellow.C,
      )[RTL#footnote[RTL = right to left. Oh, and here's a footnote!] hero with
        text and no title]
      + ".\n",
    enhanced: false,
  ),
...
#quote(attribution: [from the Henry Cary literal translation of 1897 | *Noticed
  the custom quotes?*])[
